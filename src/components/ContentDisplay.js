      ...
      <div className="data-grid">
        {currentItems.map((item) => (
          <div key={item.capsule_serial} className="grid-item">
            <img
              src="https://st2.depositphotos.com/1011081/8226/i/450/depositphotos_82268876-stock-photo-space-shuttle-taking-off-on.jpg"
      ...
      {selectedItem && (
        <div className="popup">
          <div className="popup-content">
            ...
            <img
              src="https://st2.depositphotos.com/1000647/6154/i/450/depositphotos_61546201-stock-photo-astronaut-in-outer-space.jpg"
